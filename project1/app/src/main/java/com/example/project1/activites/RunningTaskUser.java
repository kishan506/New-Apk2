...
public class RunningTaskUser extends RecyclerView.Adapter<RunningTaskUser.CardViewHolder> {

    private List<Card> dataList; // Use your Card model here
    private Context context;
    // Constructor
    public RunningTaskUser(Context context,List<Card> dataList) {
    ...
    public void onBindViewHolder(@NonNull CardViewHolder holder, int position) {
        ...
        Log.d("priority", "onBindViewHolder: "+card.getPriority());
        if(indexofpriority>3)
        {
            holder.priority.setText(priorities[indexofpriority ]);
        }
...
//        holder.spinnerPriority.setAdapter();
    ...
    public static class CardViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView priority; // Add other views as needed
        ...
        public CardViewHolder(@NonNull View itemView) {
            ...
            priority = itemView.findViewById(R.id.priorty);
